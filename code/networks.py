...
class Classifier(nn.Module):
    def __init__(
        ...
        self.conv_net = nn.Sequential(
            ConvBlock(kernel_size=5,stride=1,padding=2,out_channels=32,in_channels=in_channels,use_batch_norm=True),
            ConvBlock(kernel_size=5,stride=2,padding=2,out_channels=64,in_channels=32,use_batch_norm=True),
            nn.MaxPool2d(kernel_size=2,stride=2),
            ConvBlock(kernel_size=3,stride=1,padding=1,out_channels=64,in_channels=64,use_residual=True,use_batch_norm=True),
            ConvBlock(kernel_size=3,stride=1,padding=1,out_channels=128,in_channels=64,use_batch_norm=True),
            nn.MaxPool2d(kernel_size=2,stride=2),
            ConvBlock(kernel_size=3,stride=1,padding=1,out_channels=128,in_channels=128,use_residual=True,use_batch_norm=True),
